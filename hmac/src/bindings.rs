  ...
  pub mod fermyon {
    pub mod hmac {
      ...
      pub mod sign {
        ...
        pub type Error = super::super::super::super::fermyon::hmac::types::Error;
        const _: () = {
